namespace SikiSokoChatApp.Shared.CrossCuttingConcerns.Exceptions.Types;


/// <summary>
/// Represents an exception that is thrown when an validation error occurs.
/// </summary>
/// <remarks>
/// This exception is used to indicate that an validation error has occurred during the execution of an API request.
/// </remarks>
